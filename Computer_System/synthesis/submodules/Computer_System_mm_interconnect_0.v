...
module Computer_System_mm_interconnect_0 (
	...
	wire  [121:0] fifo_hps_to_fpga_in_agent_rf_source_data;                   // fifo_HPS_to_FPGA_in_agent:rf_source_data -> fifo_HPS_to_FPGA_in_agent_rsp_fifo:in_data
	...
	wire  [121:0] fifo_hps_to_fpga_in_agent_rsp_fifo_out_data;                // fifo_HPS_to_FPGA_in_agent_rsp_fifo:out_data -> fifo_HPS_to_FPGA_in_agent:rf_sink_data
	...
	wire  [121:0] onchip_sram_s2_agent_rf_source_data;                        // Onchip_SRAM_s2_agent:rf_source_data -> Onchip_SRAM_s2_agent_rsp_fifo:in_data
	...
	wire  [121:0] onchip_sram_s2_agent_rsp_fifo_out_data;                     // Onchip_SRAM_s2_agent_rsp_fifo:out_data -> Onchip_SRAM_s2_agent:rf_sink_data
	...
	wire  [120:0] fifo_hps_to_fpga_in_agent_rp_data;                          // fifo_HPS_to_FPGA_in_agent:rp_data -> router_002:sink_data
	...
	wire  [120:0] onchip_sram_s2_agent_rp_data;                               // Onchip_SRAM_s2_agent:rp_data -> router_003:sink_data
	...
	wire  [120:0] router_src_data;                                            // router:src_data -> ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [120:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_wr_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_axi_master_wr_limiter:rsp_src_data -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_data
	...
	wire  [120:0] router_001_src_data;                                        // router_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // ARM_A9_HPS_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [120:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_rd_limiter_rsp_src_data;          // ARM_A9_HPS_h2f_axi_master_rd_limiter:rsp_src_data -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_data
	...
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_valid
	wire  [120:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                          // fifo_HPS_to_FPGA_in_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                  // cmd_mux:src_startofpacket -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                    // cmd_mux:src_endofpacket -> fifo_HPS_to_FPGA_in_burst_adapter:sink0_endofpacket
	...
	wire  [120:0] fifo_hps_to_fpga_in_burst_adapter_source0_data;             // fifo_HPS_to_FPGA_in_burst_adapter:source0_data -> fifo_HPS_to_FPGA_in_agent:cp_data
	...
	wire  [120:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> Onchip_SRAM_s2_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                      // Onchip_SRAM_s2_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> Onchip_SRAM_s2_burst_adapter:sink0_channel
	...
	wire  [120:0] onchip_sram_s2_burst_adapter_source0_data;                  // Onchip_SRAM_s2_burst_adapter:source0_data -> Onchip_SRAM_s2_agent:cp_data
